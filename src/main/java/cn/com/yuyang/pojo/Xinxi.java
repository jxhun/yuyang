...
public class Xinxi {
  ...
  private long id;
  private long faXinId;
  private long shouXinId;
  private String xinXiBiaoTi;
  private String xinXiNeiRong;
  private long zhuangTai;
  private java.sql.Timestamp xinXiShiJian;
  private String fuJianDiZhi;
  private long faSongZhuangTai;
  private long shouCangZhuangTai;
  ...
  public java.sql.Timestamp getXinXiShiJian() {
    return xinXiShiJian;
  }

  public void setXinXiShiJian(java.sql.Timestamp xinXiShiJian) {
